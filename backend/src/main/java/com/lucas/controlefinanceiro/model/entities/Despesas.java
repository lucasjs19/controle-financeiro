...
public class Despesas {
    ...
    public Despesas(String descricao, LocalDate vencimento, DespesasTipo despesasTipo, DespesasGrupos despesasGrupos, DespesasCategorias despesasCategorias, BigDecimal valor, Integer parcela) {
